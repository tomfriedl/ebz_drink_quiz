...
content = [[sg.Text("", key='question', background_color='#FFFFFF', text_color='#000000')], [sg.Input(key='user_input', do_not_clear=False, border_width=0, justification='center', expand_x=True, background_color='#FFFFFF')], [sg.Text("", key='response', background_color='#FFFFFF', text_color='#000000')]]
...
window = sg.Window('Ebz Drink Quiz', layout, finalize=True, background_color='#FFFFFF', font=('PT Mono',12), size=(w,h))
